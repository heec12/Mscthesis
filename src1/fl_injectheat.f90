...
!Choi: Why is area 22 used for dT11 calculation? Try new delta_temp averaging like below
  dtemp_ave=(dtemp11*f11*a11+dtemp12*f12*a12+dtemp21*f21*a21+dtemp22*f22*a22)/atot

...
!  rem_threshold = 3.1558e+10 ! 1000 yrs
!  if(dt_rem .gt. rem_threshold ) then
!      itest_mesh = 1
!!     print *, 'dt_rem = ', dt_rem, 'dtout_screen', dtout_screen
!      !iac_rem = 2
!      dt_rem = 0
!      print *, 'Remeshing on purpose'!, 'dt_rem = ', dt_rem, 'rem_threshold = ', rem_threshold
!  else
!      !print *, 'Before Only dt_rem updated: dt_rem = ', dt_rem, 'rem_threshold = ', rem_threshold, ' dt=', dt
!      dt_rem = dt_rem + dt
!      !print *, 'After Only dt_rem updated: dt_rem = ', dt_rem, 'rem_threshold = ', rem_threshold, ' dt=', dt
!  endif
!  return

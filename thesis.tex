...
% Specfically, I replace conventional kinematic boundary conditions with traction boundary conditions as in~\citep{Brune2016}. I also include magmatic intrusion and faulting at a spreading center in models  
...
%the models show repeated two phase $\overline{\boldsymbol{v}}_{x}$ on both side of plates, and it coincides with the alternating faulting. 
